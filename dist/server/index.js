...
if (!process.env.DUMMY_DATA)
    (0, log_1.log)(`yellow`, `Warning: LIVE_DATA_INTERVAL is not set. Defaulting to "${constants_1.constants.DEFAULT_DUMMY_DATA}".`);
...
if (!process.env.LIVE_DATA_INTERVAL)
    (0, log_1.log)(`yellow`, `Warning: LIVE_DATA_INTERVAL is not set. Defaulting to "${constants_1.constants.DEFAULT_LIVE_DATA_INTERVAL}".`);
...
if (!process.env.SOCKET_PORT)
    (0, log_1.log)(`yellow`, `Warning: SOCKET_PORT is not set. Defaulting to "${constants_1.constants.DEFAULT_SOCKET_PORT}".`);
else if (isNaN(parseInt(process.env.SOCKET_PORT)))
    throw new Error(`SOCKET_PORT is not a number.`);
if (!process.env.WEBFRONT_PORT)
    (0, log_1.log)(`yellow`, `Warning: WEBFRONT_PORT is not set. Defaulting to "${constants_1.constants.DEFAULT_WEBFRONT_PORT}".`);
